...
// Mock the '@actions/artifact' module
// CHANGED: Define mocks for uploadArtifact and downloadArtifact at the top level
...
describe('action', () => {
  ...
  describe('run', () => {
    ...
    beforeEach(() => {
      jest.clearAllMocks(); // CHANGED: Reset mocks between tests
